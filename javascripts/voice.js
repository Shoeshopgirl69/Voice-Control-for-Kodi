...
function main() {
	...
	KodiIP = '127.0.0.1';
	KodiPort = '8080'
	RadarrIP = '10.178.0.118';
	RadarrPort = '7878';
	DelugeIP = '10.178.0.118';
	DelugePort = '8112';
	NetworkShareIP = '10.178.0.100'; // The hostname or IP for Radarr to save to. Example: \\This Part of the UNC\sharename
	ShareName = 'movies'; // The share name for Radarr. Example: \\hostname\This part of the UNC
	apiKeyTheMovieDB = '157ab3cbdf2b143cbf07caab87c6a5ba'; // If this stops working, you can get your own key
	...
	if (command == 'play') {
		...
		if ( mediaType == 'movie' ) {
			...
			if ( xhttp.responseText == '{"id":"libMovies","jsonrpc":"2.0","result":{"limits":{"end":0,"start":0,"total":0}}}' ) {
				...
				JSONData = '{"id": 1, "jsonrpc": "2.0", "method": "Files.GetDirectory","params":{"directory":"plugin://plugin.video.exodus/?action=moviePage&url=' + traktUrl + '" } }';
				sendJSONData();
		...
		if ( mediaType == 'tv' ) {
			...
			if ( xhttp.responseText == '{"id":"libTvShows","jsonrpc":"2.0","result":{"limits":{"end":0,"start":0,"total":0}}}' ) {
				JSONData = '{"id":1,"jsonrpc":"2.0","method": "Files.GetDirectory","params":{"directory":"plugin://plugin.video.exodus/?action=calendar&url=progress"}}}';
				sendJSONData();
				...
				try {
					...
					if ( error.message == 'episodeInfo is not defined' ){
						...
						JSONData = '{"id": 1, "jsonrpc": "2.0", "method": "Files.GetDirectory","params":{"directory":"plugin://plugin.video.exodus/?action=tvshowPage&url=' + traktUrl + '" } }';
						sendJSONData();
		...
		if ( payload == 'exodus' ) {
			JSONData = '{"jsonrpc":"2.0","method":"GUI.ActivateWindow","params":{"window":"videos","parameters":["plugin://plugin.video.exodus"]},"id":1}';
			sendJSONData();
		}
